/**
 * 消息提示插件
 * XY.msgbox.show(msgHtml, type, timeout, opts)
 * msgHtml: 提示内容
 * type: 提示类型(1-警告, 4-成功, 5-失败, 6-加载中)
 */
(function (window, undefined) {
  ...
  XY.dom = {
    ...
    createElementIn: function (tagName, elem, insertFirst, attrs) {
      var _e = (elem = XY.dom.get(elem) || document.body).ownerDocument.createElement(tagName || "div"),
        k;
  ...
  XY.msgbox.loadingAnimationPath = XY.msgbox.loadingAnimationPath || ("../msgbox/images/loading.gif");
  ...
  XY.msgbox.show = function (msgHtml, type, timeout, opts) {
    ...
    opts = opts || {};
    var _s = XY.msgbox,
      template = '<span class="xy_msgbox_layer" style="display:none;z-index:10000;" id="mode_tips_v2"><span class="gtl_ico_{type}"></span>{loadIcon}{msgHtml}<span class="gtl_end"></span></span>',
      loading = '<img src="' + (opts.customIcon || _s.loadingAnimationPath) + '" alt="" />',
      typeClass = [0, 0, 0, 0, "succ", "fail", "clear"],
      mBox, tips;
    _s._loadCss && _s._loadCss(opts.cssPath);
    mBox = XY.dom.get("q_Msgbox") || XY.dom.createElementIn("div", document.body, false, {
      className: "xy_msgbox_layer_wrap"
    });
    mBox.id = "q_Msgbox";
    mBox.style.display = "";
    mBox.innerHTML = XY.string.format(template, {
  ...
  XY.msgbox._setPosition = function (tips, timeout, topPosition) {
    ...
    var _s = XY.msgbox,
      bt = XY.dom.getScrollTop(),
      ch = XY.dom.getClientHeight(),
